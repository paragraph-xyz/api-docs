...
<Card title="Get started with the SDK" icon="rocket" horizontal href="/development/sdk">
...
<Columns cols={2}>
  <Card title="SDK Quickstart" icon="bolt" href="/development/sdk">
    Get up and running with our TypeScript SDK in just a few lines of code.
  </Card>
  <Card title="Code Examples" icon="code" href="/development/sdk/examples">
    Explore practical examples for common use cases like fetching posts and managing coins.
  </Card>
  <Card title="API Reference" icon="terminal" href="/api-reference/publications/get-publication-by-id">
    Browse the complete REST API documentation with detailed endpoint specifications.
  </Card>
  <Card title="OpenAPI Spec" icon="file-code" href="https://github.com/paragraph-xyz/paragraph-sdk-js/blob/main/openapi.json">
...
<Columns cols={2}>
  <Card title="Publications" icon="newspaper" href="/api-reference/publications/get-publication-by-id">
    Access publication metadata, settings, and content collections.
  </Card>
  <Card title="Posts" icon="pen-fancy" href="/api-reference/posts/list-posts-in-a-publication">
    Fetch posts with pagination, filtering, and full content support.
  </Card>
  <Card title="Coins" icon="coins" href="/api-reference/coins/get-coin-by-id">
    Integrate coin functionality for monetization and community support.
  </Card>
  <Card title="User Profiles" icon="user" href="/api-reference/users/get-user-by-id">
...
<Columns cols={2}>
  <Card title="View SDK on GitHub" icon="github" href="https://github.com/paragraph-xyz/paragraph-sdk-js">
    Explore the SDK source code, contribute, or report issues.
  </Card>
  <Card title="View docs on GitHub" icon="github" href="https://github.com/paragraph-xyz/api-docs">
