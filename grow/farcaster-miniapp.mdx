...
### **How to install the Paragraph mini app**

To add the Paragraph mini app in the Farcaster app:

1. Open this link on your device: [Install Paragraph Mini App](https://farcaster.xyz/miniapps/LmKmOXHLnXu9/paragraph) (you can also search for "Paragraph" in Farcaster's [Mini Apps tab](https://farcaster.xyz/miniapps)).
2. Tap **Install** (or **Add**) and go through any verification steps.
3. Once installed, you can read, subscribe, and support writers right from your Farcaster feed.

### **How to take advantage as a writer**
