...
Set up a custom domain to strengthen your brand and retain the SEO value you build over time. Instead of `paragraph.xyz/@username`, your publication can live at `example.com` or `blog.example.com`.
